  ...
  return (
    ...
    >
      ...
      <Box display="flex" flexDirection="column" gap={1}>
        <Typography fontSize={22} fontWeight={600} color="#374151">
          Profit Report
        </Typography>
        <Box
          sx={{
        ...
        <Box display="flex" alignItems="center" gap={0.5}>
          ...
          <Typography fontSize={14} fontWeight={600} color="#10b981">
            68.2%
          </Typography>
        </Box>
        <Typography fontSize={24} fontWeight={700} color="#111827">
          $84,686k
        </Typography>
      </Box>
