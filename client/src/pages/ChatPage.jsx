...
import TeamMembersCard from './CRMcomponents/CustomersMembersCard';
import SessionsCard from './CRMcomponents/SessionsCard'; // 导入 SessionsCard
    ...
    <Box sx={getCrmStyle('crmMain', theme)}>
      <Box sx={getCrmStyle('crmContent', theme)}>
        <Grid container spacing={3} sx={{ alignItems: 'stretch' }}>
          {/* Left Section: Customer Rating, Overview & Sales Activity */}
          <Grid size={{ xs: 12, md: 10, lg: 8 }} sx={{ display: 'flex' }}>
          ...
          {/* Right Section: Orders, Generated Leads, Sessions */}
          <Grid size={{ xs: 12, md: 2, lg: 4 }} sx={{ display: 'flex' }}>
            <Grid container spacing={3}>
              {/* Orders */}
              ...
              {/* Generated Leads */}
              <Grid size={{ xs: 12, md: 12, lg: 12 }} sx={{ display: 'flex' }}>
                <GeneratedLeadsCard theme={theme} />
              </Grid>

              {/* Sessions */}
              <Grid size={{ xs: 12, md: 12, lg: 12 }} sx={{ display: 'flex' }}>
                <SessionsCard theme={theme} />
              </Grid>
            </Grid>
          </Grid>
