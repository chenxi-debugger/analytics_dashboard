...
export const rawEventsMap = {
  prev: [
    ...
    { id: 103, day: 6, title: 'Family Picnic', color: '#ffecd1', category: 'Family', allDay: true },
    { id: 104, day: 8, hour: 8, minute: 0, durationMins: 90, title: 'Client Meeting', color: '#e0e7ff', category: 'Business' },
    ...
    { id: 107, day: 16, hour: 9, minute: 0, durationMins: 120, title: 'Morning Sync', color: '#d4f8e8', category: 'Business' },
  ...
  current: [
    ...
    { id: 204, day: 8, title: 'Mom’s Birthday', color: '#ffecd1', category: 'Family', allDay: true },
    { id: 205, day: 10, hour: 9, minute: 0, durationMins: 120, title: 'Project Kickoff', color: '#e0e7ff', category: 'Business' },
    { id: 206, day: 12, hour: 10, minute: 30, durationMins: 120, title: 'Evening Jog', color: '#ffdad6', category: 'Personal' },
    { id: 207, day: 15, title: 'Anniversary Dinner', color: '#ffecd1', category: 'Family', allDay: true },
    { id: 208, day: 18, title: 'Family Dinner', color: '#ffecd1', category: 'Family', allDay: true },
    { id: 209, day: 20, hour: 8, minute: 0, durationMins: 180, title: 'Weekly Sync', color: '#d4f8e8', category: 'Business' },
    { id: 210, day: 22, endDay: 24, title: 'Trip to Lake', color: '#d4f8e8', category: 'Family', allDay: true },
  ],
  next: [
    { id: 301, day: 1, title: 'Rent Due', color: '#ffdad6', category: 'Personal', allDay: true },
    ...
    { id: 304, day: 6, hour: 9, minute: 0, durationMins: 120, title: 'Team Check-In', color: '#d4f8e8', category: 'Business' },
    ...
    { id: 307, day: 15, title: 'Spa Day', color: '#ffdad6', category: 'Personal', allDay: true },
    { id: 308, day: 18, hour: 8, minute: 0, durationMins: 160, title: 'Mentorship Session', color: '#e0e7ff', category: 'Business' },
    { id: 309, day: 20, title: 'Family BBQ', color: '#ffecd1', category: 'Family', allDay: true },
